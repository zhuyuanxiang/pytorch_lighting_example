"""
=================================================
@path   : pytorch_lighting_example -> train_pytorch_transformer_reverse
@IDE    : PyCharm
@Author : zYx.Tom, 526614962@qq.com
@Date   : 2022/11/21 10:57
@Version: v0.1
...
def cli_main(config: ConfigTransformerReverse):
    ...
    model = ReversePredictor(
            input_dim=config.lit_module.input_channels,
            module_parameters=config.lit_module)
